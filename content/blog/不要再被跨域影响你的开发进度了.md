...
</pre><p>﻿之后我们再做请求，发现此时已经正确携带了相关头部信息，请求也能正确处理了。</p><h2>总结</h2><p>跨域问题的解决很简单，在理解了相关原理后，通过必要的步骤进行处理即可。当然，其解决方案远不止上面罗列的几种形式，并且需要注意，以上方案等仅做测试使用，即使是nginx的方案。在生产环境中的跨域问题的解决，远比上面的简易方案要考虑的更多。不过通常生产环境的跨域问题会有更加专业的人士负责处理。希望本文可以帮到你，拯救你可能浪费的时间。</p>